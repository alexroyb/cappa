    ...
    renderResultsHTML(posts){
      if(posts.length){
        ...
        ${posts.map((post)=>{
          ...
          <img class="avatar-tiny" src="${post.author.avatar}"> <strong>${post.title}1</strong>
        ...
        this.resultsArea.innerHTML = `<p class = "alert alert-danger text-center shadow-sm">Sorry, no result</p>`
      }
      this.hideLoaderIcon()
